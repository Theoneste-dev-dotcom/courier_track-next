    ...
    return(
        <>
            <article className="prose">
              ...
              <ul>
                  <li><Link href="https://reactjs.org/" target="_blank">React JS v18.2.0</Link></li>
                  <li><Link href="https://reactrouter.com/en/main" target="_blank">React Router v6.4.3</Link></li>
                  <li><Link href="https://tailwindcss.com/" target="_blank">Tailwind CSS v3.3.6</Link></li>
                  <li><Link href="https://daisyui.com/" target="_blank">Daisy UI v4.4.19</Link></li>
                  <li><Link href="https://heroicons.com/" target="_blank">HeroIcons v2.0.13</Link></li>
                  <li><Link href="https://redux-toolkit.js.org/" target="_blank">Redux toolkit v1.9.0</Link></li>
                  <li><Link href="https://react-chartjs-2.js.org/" target="_blank">React ChartJS 2 v5.0.1</Link></li>
              </ul>
              ...
              <h2 id="getstarted2">How to use?</h2>
                <p>
                    ...
                    <Link href="https://github.com/srobbin01/daisyui-admin-dashboard-template" className='text-sm text-blue-500' target="_blank">Repo Link</Link>
                    <br />
              ...
              <p><Link href="https://daisyui.com/" target="_blank" className='text-xl btn-link'>Daisy UI</Link>, a popular free and opensource tailwind component library has been used for this template. It has a rich collection of components, layouts and is fully customizable and themeable.</p>
              
              <p>Apart from this it also helps in making HTML code more cleaner as we don't have to include all utility classes of tailwind to make the UI. Check components <Link href="https://daisyui.com/components/button/" target="_blank" className='btn-link'>documentation here</Link>. For Ex- </p>
              ...
              <h2 id="getstarted5">Chart JS</h2>
                 <p>
                 Chart JS library has rich components of different charts available. It is based on  <Link href="https://www.chartjs.org/" target="_blank" alt=""> Chart.js</Link> library, the most popular charting library. We have added this library and added couple of examples in seperate page.
                 </p>
              ...
              <h2 id="getstarted7">Hero Icons</h2>
                <p><Link href="https://heroicons.com/" target="_blank" className='text-xl btn-link'>HeroIcons</Link> library has been used for all the icons in this templates. It has a rich collection of SVG icons, and is made by the makers of Tailwind CSS.</p>

                <p className='mt-4'>Each icon can be imported individually as a React component, check <Link href="https://github.com/tailwindlabs/heroicons" target="_blank" className='btn-link'>documentation</Link></p>
